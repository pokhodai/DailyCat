...
import com.cat.daily.local.core.uikit.base.ext.getColorStateList
import com.cat.daily.local.core.uikit.base.ext.getDrawable
import com.cat.daily.local.core.uikit.base.ext.hideKeyboard
import com.cat.daily.local.core.uikit.databinding.ViewTextFieldBinding
...
class TextFieldItemView @JvmOverloads constructor(
    ...
    private fun bindFooter(state: TextFieldItem.State) {
        binding.fieldFooter.bindTextOptional(state.footer)
