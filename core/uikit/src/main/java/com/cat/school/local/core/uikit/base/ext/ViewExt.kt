...
import com.cat.school.local.core.uikit.base.value.RoundValue
import com.cat.school.local.core.uikit.base.value.RoundValue.Corners
...
fun View.makeRounded(value: Corners) {
    clipToOutline = true
...
fun View.makeRounded(value: RoundValue?) {
    when (value) {
        is Corners -> makeRounded(value)
        is RoundValue.Radius -> makeRounded(value.value)
        else -> makeRounded(DimensionValue.Dp(0))
    }
}

private fun Corners.isOnlyRightCorners() = leftTopRound.value == 0 &&
        leftBottomRound.value == 0 &&
        rightBottomRound.value > 0 &&
        rightBottomRound == rightTopRound

private fun Corners.isOnlyLeftCorners() = rightTopRound.value == 0 &&
        rightBottomRound.value == 0 &&
        leftTopRound.value > 0 &&
        leftTopRound == leftBottomRound

private fun Corners.isOnlyBottomCorners() = leftTopRound.value == 0 &&
        rightTopRound.value == 0 &&
        rightBottomRound.value > 0 &&
        rightBottomRound == leftBottomRound

private fun Corners.isOnlyTopCorners() = leftBottomRound.value == 0 &&
        rightBottomRound.value == 0 &&
        rightTopRound.value > 0 &&
        rightTopRound == leftTopRound

private fun Corners.isAllCorners() = rightTopRound.value > 0 &&
